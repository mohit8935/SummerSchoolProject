...
hist = classifier.fit_generator(
                          ...
                          validation_steps = 2000/batch_size,callbacks=[tensorboard]
                                )
...
classifier.save_weights('/output/model.h5')
classifier.save('/output/model.hdf5')
"""
from keras.utils import plot_model
plot_model(classifier, to_file='/output/model.png')"""
